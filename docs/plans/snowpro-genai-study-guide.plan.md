# Plan: SnowPro Gen AI Exam Study Guide

## Summary
Create an exam-focused study guide for the SnowPro Specialty: Gen AI Certification (C02),
organized as per-domain markdown files with concise exam-relevant content and documentation
references. The guide follows the official exam study guide structure (4 domains, weighted 18/38/29/15%).
...
| File | Purpose |
| --- | --- |
| `README.md` | Index with exam overview, domain weightings, study strategy |
| `domain-1-gen-ai-overview.md` | Domain 1.0 (18%) — Snowflake for Gen AI Overview |
| `domain-2-gen-ai-functions.md` | Domain 2.0 (38%) — Snowflake Gen AI Functions |
| `domain-3-gen-ai-governance.md` | Domain 3.0 (29%) — Snowflake Gen AI Governance |
| `domain-4-document-processing.md` | Domain 4.0 (15%) — Snowflake Document Processing |
| `sample-questions.md` | Practice questions with explained answers |
